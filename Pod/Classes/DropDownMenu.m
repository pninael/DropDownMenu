...
-(id)initWithFrame:(CGRect)frame andMenuItems:(DDMenuItem*)firstItem, ...
{
...
-(id)initWithFrame:(CGRect)frame andMenuItems:(DDMenuItem*)firstItem otherItems:(va_list)vaList
{
    ...
    if(self)
    {
        ...
        int itemIndex = 0;
        for (DDMenuItem* menuAction in items)
        {
